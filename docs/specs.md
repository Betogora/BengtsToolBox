...
- Absolvierte Einheiten benötigen Datum, Disziplin sowie Dauer oder Distanz. Je zwei Angaben aus Dauer, Distanz und Durchschnittspace berechnen die dritte Größe; die Pace gilt beim Schwimmen pro 100 Meter, sonst pro Kilometer. Optional sind Zeit, Kontext, Durchschnittspuls, Durchschnittsleistung, RPE und manuell aufgebaute Belastungs-/Pausenintervalle.
- Die Tabs Kalender, Tagebuch und Statistik trennen Planung, Erfassung und Auswertung. Monats- und Wochenkalender enthalten ausschließlich Soll-Einheiten als Tageskarten mit Wochensummen. Einzelne Pläne lassen sich kopieren oder per Drag-and-drop verschieben; das Datumsfeld im Editor bietet dieselbe Verschiebung per Tastatur und mobil. Mobil zeigt der Monat ein Datumsgitter mit Tagesagenda und die Woche eine vertikale Agenda. Ab 768 Pixeln stehen die sieben Wochentage nebeneinander.
- Absolvierte Einheiten stehen ausschließlich im Tagebuch und in der Statistik. Das Tagebuch zeigt alle Datensätze mit getrennten Messwertspalten, Disziplin- und Datumsfiltern, Datumssortierung und Seiten zu 20 Einträgen. Die Erfassungsmaske gliedert sich in Training, Messwerte und optionale Detailangaben.
...
- Leistungsmodelle verwenden höchstens drei Monate kontinuierlicher, kontextgleicher Einheiten. Intervalle sind keine Modellanker. Individuelle Modelle benötigen drei geeignete Anker; Ausnahmen sind Riegel aus einem Lauf von 5–21,1 km und CSS aus zwei maximalen 200-/400-m-Tests. Markierte Leistungstests werden bevorzugt, sonst werden Trainingsäquivalente ausgewiesen; die Leistungskarten nennen vorhandene und benötigte geeignete Trainings.
...
- Sind nach allen 15 Spielen beide Scores gleich, erscheint Spiel 16 als Stechen. Es entscheidet den Abend per Kreuz, vergibt aber keine Punkte und zählt nicht als gewonnenes Spiel.
